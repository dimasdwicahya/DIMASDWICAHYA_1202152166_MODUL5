...
public class AppSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Pengaturan"); // untuk judul aplikasi yang ditambilkan pada actionbar

        //Membuat dialog baru
        mAlertDialog = new AlertDialog.Builder(this);

        //menginisialisasi sharedpreference
        ...
        warna = findViewById(R.id.tvShapeColor);
    ...
    public void pilihWarna(View view) {
        ...
        mAlertDialog.setTitle("Shape Color");
        //membuat view baru
        View view1 = getLayoutInflater().inflate(R.layout.activity_color_setting, null);
